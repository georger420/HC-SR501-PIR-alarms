...
The fist version is built using Raspberry Pi Pico and modules KY-004 (button), KY-11 (two color LED), KY-012 (active buzzer), and ofcourse HC-SR501. The code is in CircuitPython. Regarding costs it is most expensive.
